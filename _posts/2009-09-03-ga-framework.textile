...
As my title suggests, I built a framework for constructing genetic algorithms in Clojure. While the definition of framework is debatable, excuse the pretension: I mean only that it's something I can reuse. 
